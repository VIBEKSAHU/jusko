          ...
          <TableBody>
            {data.map((row, idx) => (
              <StyledTableRow key={row.customer_id}>
                ...
                <StyledTableCell align="left"> {row?.pickup_estb_name + ", " + (row.pickup_street !== null ? row.pickup_street + ', ' : ' ') + " " + (row.pickup_locality !== null ? row.pickup_locality + ', ' : '') + "" + row.pickup_city + ", " + (row.pickup_region === '34' ? 'Jharkhand' : row.pickup_region) + ", " + row?.pickup_postal_code}</StyledTableCell>
                <StyledTableCell align="left"> {row?.mobile_no}</StyledTableCell>
                <StyledTableCell align="left"> {row?.pickup_zone}</StyledTableCell>
                <StyledTableCell align="left"> {row?.pickup_area}</StyledTableCell>
                <StyledTableCell align="left"> {row?.pickup_locality}</StyledTableCell>
