...
export default function UpdateCustProfile() {
  ...
  const fetchUser = async (e) => {
    const login = await axios
      .post("/customerLogin", { username: userId, password: "" })
      .then((res) => {
        console.log("Response :: "+res?.data.customer_id);
  ...
  return (
    <>
      <Container maxWidth="xl" sx={styles.container}>
        ...
        <Typography sx={styles.dashboardText}>Update Customer Profile</Typography>
